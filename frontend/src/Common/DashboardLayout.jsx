...
const DashboardLayout = ({ children, role, title, subtitle, themeColor = '#22c55e', bgImage, withGlassCard = true }) => {
    ...
    return (
        <div style={{ 
            display: 'flex', 
            minHeight: '100vh', 
            backgroundImage: `url("${bgImage || 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=2070&auto=format&fit=crop'}")`,
            ...
            <div style={{ zIndex: 1, position: 'relative', width: '100%', display: 'flex' }}>
                <Sidebar role={role} theme="dark" accentColor={themeColor} />
                ...
                <main style={{ marginLeft: '280px', flexGrow: 1, color: '#f8fafc', display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div className="position-relative">
                                ...
                                {dropdownOpen && (
                                     <div className="position-absolute shadow-lg" style={{ 
                                         ...
                                         {role !== 'Admin' && (
                                             <>
                                                 <div onClick={() => window.location.href='/profile'} className="px-3 py-3 d-flex align-items-center gap-2 text-white" style={{ fontSize: '0.9rem', cursor: 'pointer' }}>
                    ...
                    <div style={{ padding: '3.5rem' }}>
                        <header className="mb-5 d-flex justify-content-between align-items-center">
                            <div>
                                <h1 style={{ fontSize: '2.4rem', fontWeight: 800, letterSpacing: '-0.5px' }}>
                                    {title}
                                </h1>
